...
public class Monster_GreenStar extends Monster {
    private int xC = 66;
    private int yC = 66;

    String name = "RedDot";
    String description = "a red lill cutie";
    ImageIcon monsterIcon = new ImageIcon("res/monsters/GreenStarMonster.png");
    ...
    public Monster_GreenStar(Integer lvl){
        this.HP = 20 + (lvl *15);
        this.MAX_HP = 20 + (lvl *15);
        this.velocity = 4 + (int) Math.round((lvl/10));
