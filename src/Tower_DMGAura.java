...
public class Tower_DMGAura extends Tower {

    private int yC;
    private int xC;

    ImageIcon towerIcon = new ImageIcon("res/towers/BlackBlast.png");
    ...
    private int ats = 10;
    private int price;
    private String type = "AuraDMG";

    public Tower_DMGAura(int lvl){
        this.level = lvl;
        //per level
        ...
        this.name = "DMG Buff ("+type+"): Lv(" +lvl +")";
        this.description = "Buffs nearby towers Damage \nDMG: "+dmg+"       AtkS: "+ats+"\nRange: " +range+"    Price: " +price;

    }

    @Override
    public Tower copy(){
        Tower newT = new Tower_DMGAura(this.getLVL());
        return newT;
    }
