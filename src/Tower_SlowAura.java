...
public class Tower_SlowAura extends Tower {

    private int yC;
    private int xC;

    ImageIcon towerIcon = new ImageIcon("res/towers/BlueSlow.png");
    ...
    private int ats;
    private int price;
    private String type = "AuraSlow";

    public Tower_SlowAura(int lvl){
        this.level = lvl;
        //per level
        ...
        this.name = "Slow Aura ("+type+"): Lv(" +lvl +")";
        this.description = "Slows nearby monsters \nDMG: "+dmg+"       AtkS: "+ats+"\nRange: " +range+"    Price: " +price;

    }

    @Override
    public Tower copy(){
        Tower newT = new Tower_SlowAura(this.getLVL());
        return newT;
    }
